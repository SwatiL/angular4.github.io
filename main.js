...
module.exports = "\n<!-- <div *ngIf=\"selectedHero\">\n \n    <h2>{{selectedHero.name | uppercase}} Details</h2>\n    <div><span>id: </span></div>\n    <div>\n      <label>{{selectedHero.id}}\n        <input [(ngModel)]=\"selectedHero.name\" placeholder=\"name\">\n      </label>\n    </div>\n   \n  </div> -->\n  <div *ngIf=\"hero\">\n\n      <h2>{{hero.name | uppercase}} Details</h2>\n      <!-- <div><span>id: </span></div> -->\n      <div>\n        <label>\n           <span > {{hero.id}}</span><span><input [(ngModel)]=\"hero.name\" placeholder=\"name\"/></span>\n        </label>\n      </div>\n    \n    </div>\n    <button (click)=\"goBack()\">go back</button>"
...
module.exports = "<div *ngIf = \"messageService.messages.length\">\n  <h2>Hello World!!!</h2>\n  <button class=\"clear\" (click)=\"messageService.clear()\">Clear</button>\n  <div *ngFor =\"let  message of messageService.messages\" >{{messages}}</div>\n</div>"
...
module.exports = __webpack_require__(/*! E:\Type_script\tour-of-heroes\src\main.ts */"./src/main.ts");
